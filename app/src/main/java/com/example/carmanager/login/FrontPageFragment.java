    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CreateCarFragment createCarFragment = CreateCarFragment.newInstance("","");
                FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.layout, createCarFragment, "createCarFragment");
        ...
        buttonJoin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                JoinCarFragment joinCarFragment = JoinCarFragment.newInstance("","");
                FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.layout, joinCarFragment, "joinCarFragment");
                fragmentTransaction.commit();
            }
        });
